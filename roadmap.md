...
- [x] Approve the new DIEGCUTZ visual direction and information architecture
- [x] Rebuild every customer-facing page, overlay, menu, notification, and PWA surface
