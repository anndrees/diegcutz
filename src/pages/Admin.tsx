      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center gap-2 ml-auto">
            {loyaltyEnabled && (
              <Button variant="outline" onClick={() => setShowQrScanner(true)} className="border-primary/50 text-primary">
        ...
        <ActiveAppointmentBanner onOpenQrScanner={loyaltyEnabled ? () => setShowQrScanner(true) : undefined} />
        ...
        {/* QR Scanner */}
        {loyaltyEnabled && <QrScanner open={showQrScanner} onOpenChange={setShowQrScanner} />}
      </div>
    </div>
    </AdminGuard>
  );
