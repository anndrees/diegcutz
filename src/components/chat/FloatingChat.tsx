  ...
  return (
    <>
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-1 -right-1 bg-secondary text-background text-xs font-bold w-5 h-5 rounded-full flex items-center justify-center">
            ...
            <div className="space-y-3">
              ...
              {adminTyping && (
                <div className="flex justify-start">
                  <div className="bg-muted rounded-lg rounded-bl-md px-4 py-2">
                    <div className="flex gap-1">
