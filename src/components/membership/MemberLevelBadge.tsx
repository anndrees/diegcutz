...
const LEVELS = [
  ...
  { min: 6, name: "Gold", color: "text-primary", bg: "bg-primary/10 border-primary/30", glow: "" },
  { min: 12, name: "Diamond", color: "text-secondary", bg: "bg-secondary/10 border-secondary/30", glow: "" },
];
...
export const MemberLevelBadge = ({ consecutiveMonths, showLabel = true, size = "sm" }: Props) => {
  ...
  return (
    <div className={`inline-flex items-center gap-1 px-2 py-0.5 border text-xs font-bold ${level.bg} ${level.glow}`}>
