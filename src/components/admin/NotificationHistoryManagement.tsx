...
import { Bell, RefreshCw, User, Users, CheckCircle, XCircle, Clock, AlertCircle, Send, History } from "lucide-react";
import { Link } from "react-router-dom";
import { AdminBroadcastNotification } from "./AdminBroadcastNotification";
...
const typeLabels: Record<string, { label: string; icon: React.ReactNode; color: string }> = {
  ...
  admin_broadcast: { label: "Admin Broadcast", icon: <Send className="h-4 w-4" />, color: "text-primary" },
  admin_message: { label: "Mensaje Admin", icon: <Send className="h-4 w-4" />, color: "text-primary" },
};
